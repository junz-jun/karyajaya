    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-[#111813] border-r border-border-dark flex-shrink-0 flex flex-col justify-between h-full transform -translate-x-full md:translate-x-0 md:static transition-transform duration-300 ease-in-out">
        <div class="flex flex-col p-4 gap-6">
            ...
            <nav class="flex flex-col gap-1">
                ...
                <a href="diagnosa.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 text-primary transition-colors">
                    <span class="material-symbols-outlined fill-1">stethoscope</span>
                    <span class="text-sm font-medium">Diagnosa</span>
                </a>
                <a href="riwayat.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:text-white hover:bg-white/5 transition-colors">
    ...
    <main class="flex-1 flex flex-col min-h-screen relative overflow-x-hidden">
        ...
        <div class="flex-1 bg-background-dark p-6 md:p-10">
            <div class="max-w-5xl mx-auto flex flex-col gap-8 pb-32">
                ...
                <form action="hasil.php" method="POST" id="diagnosisForm">
                    <div class="mb-6">
                    ...
                    <div class="fixed bottom-0 left-0 md:left-64 right-0 bg-[#111813]/90 backdrop-blur-md border-t border-border-dark p-4 md:px-10 z-20">
                        <div class="max-w-5xl mx-auto flex justify-between items-center">
                            ...
                            <button type="submit" class="text-black bg-primary hover:bg-green-400 font-bold rounded-lg text-sm px-6 py-3 transition-all shadow-[0_0_15px_rgba(23,207_84,0.4)] flex items-center gap-2">
